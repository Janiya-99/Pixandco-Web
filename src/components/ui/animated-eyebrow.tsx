...
export function AnimatedEyebrow({ text, className }: { text: string, className?: string }) {
  ...
  return (
    <div ref={ref} className={cn("eyebrow mb-7 relative z-10 inline-flex overflow-hidden border-l-2 border-white/50 px-3 py-1.5 text-white/70 uppercase", className)}>
      <motion.div 
