...
export function SiteHeader() {
  ...
  return (
    <header className={`fixed inset-x-0 top-0 z-50 border-b border-white/10 transition-all duration-500 ${scrolled || open ? "bg-[#010004]/88 backdrop-blur-xl" : "bg-transparent"} ${hidden && !open ? "-translate-y-full" : "translate-y-0"}`}>
