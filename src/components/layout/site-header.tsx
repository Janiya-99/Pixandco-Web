  ...
  return (
    <header className={`fixed inset-x-0 top-0 z-50 border-b transition-all duration-500 ${scrolled || open ? "border-[#212121] bg-[#010004]/88 backdrop-blur-xl" : "border-transparent bg-transparent"}`}>
      <Container className="flex h-[76px] items-center justify-between">
        <Link className="focus-ring relative z-[60] flex items-center gap-3" href="/" onClick={() => setOpen(false)}><span className="grid size-7 place-items-center border border-white/50 text-[10px] font-semibold">N</span><ScrambleText className="text-sm font-medium tracking-[.14em]" text="NORTHLINE" delay={0.12} /></Link>
